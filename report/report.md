...
|--------------------------|------------------------|-----------------------|------------------------|------------------------|
| **Logos**                | ![D'Taquito Logo](https://raw.githubusercontent.com/HenryCenturion/open-source-final-project/develop/informe/images/logo.jpg) | ![Xporty Logo](https://www.xporty.com/assets/logo.png) | ![Timpik Logo](https://www.timpik.com/img/logo_timpik.png) | ![Fubles Logo](https://www.fubles.com/images/logo.png) |
...
| **Oportunidades**         | Expansión a otras regiones del Perú y potencialmente a otros países de América Latina, aprovechando la creciente demanda de soluciones digitales en el deporte. | Expansión de su oferta para incluir más deportes y regiones, así como la integración con otras plataformas deportivas. | Crecimiento a través de la expansión internacional y la incorporación de más deportes en su red social. | Expansión a otros deportes y mercados internacionales, capitalizando su enfoque en la comunidad deportiva. |
...
https://github.com/Tecny/software-architecture-fundamentals-final-project/tree/report
